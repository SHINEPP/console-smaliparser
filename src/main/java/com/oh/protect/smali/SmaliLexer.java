...
public class SmaliLexer extends Lexer {
	...
	public static final int
		ANNOATION_MODE=1, FIELD_MODE=2, METHOD_MODE=3;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "ANNOATION_MODE", "FIELD_MODE", "METHOD_MODE"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"ANNOTATION", "ANNOTATION_END", "FIELD", "FIELD_END", "METHOD", "METHOD_END", 
			"CR", "NCR", "COMMENT", "CLASS_DEF", "SUPER_DEF", "SOURCE_DEF", "IMPLEMENTS_DEF", 
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 18:
			return ANNOATION_BLOCK_LINE_sempred((RuleContext)_localctx, predIndex);
		case 20:
	...
	private boolean ANNOATION_BLOCK_LINE_sempred(RuleContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0:
			return  !getText().startsWith(".end annotation") ;
		}
		return true;
	}
