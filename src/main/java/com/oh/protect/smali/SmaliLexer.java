...
public class SmaliLexer extends Lexer {
	...
	public static final int
		COMMENT=1, CLASS=2, SUPER=3, SOURCE=4, IMPLEMENTS=5, ANNOTATION_BLOCK=6, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CR", "COMMENT", "CLASS", "SUPER", "SOURCE", "IMPLEMENTS", "ANNOTATION_BLOCK", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "COMMENT", "CLASS", "SUPER", "SOURCE", "IMPLEMENTS", "ANNOTATION_BLOCK", 
			"FIELD_BLOCK_START", "FIELD_DEF", "METHOD_BLOCK_START", "PUBLIC", "PRIVATE", 
			"PROTECTED", "STATIC", "FINAL", "SIGN_OBJECT", "WS", "FIELD_BLOCK_END", 
			"FIELD_BLOCK_LINE", "METHOD_BLOCK_END", "METHOD_BLOCK_LINE"
		};
